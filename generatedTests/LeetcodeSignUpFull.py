...
def main():
    ...
    elem = find_elem({'tag': 'a', 'value': 'Create Account', 'attrs': {'href': 'signup', 'title': 'Sign Up'}})
    ...
    elem = find_elem({'tag': 'input', 'value': '', 'attrs': {'name': 'username'}})
    
    elem.send_keys("testusertest")
    
    time.sleep(3)
    send_screenshot(sio)

    elem = find_elem({'tag': 'input', 'value': '', 'attrs': {'type': 'password1', 'name': 'password1', 'value': ''}})
    
    elem.send_keys("testuserpass")
    
    time.sleep(3)
    send_screenshot(sio)

    elem = find_elem({'tag': 'input', 'value': '', 'attrs': {'type': 'password', 'placeholder': 'Confirm Password'}})
    ...
    elem = find_elem({'tag': 'input', 'value': '', 'attrs': {'type': 'email', 'placeholder': 'email address'}})
