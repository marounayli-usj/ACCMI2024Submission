...
def main():
    ...
    elem = find_elem({'tag': 'a', 'value': 'Sign In', 'attrs': {'class': 'sign-in-button', 'position': 'top-right'}})
    ...
    elem = find_elem({'tag': 'input', 'value': '', 'attrs': {'type': 'text', 'name': 'username', 'placeholder': 'username'}})
